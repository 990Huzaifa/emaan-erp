...
class CustomerController extends Controller
{
    ...
    public function list():JsonResponse
    {
        try{
            ...
            $customers = Customer::select('customers.id', 'customers.name', 'customers.address', 'customers.c_code as code', 'customers.acc_id', 'customers.class', 'customers.credit_limit')
